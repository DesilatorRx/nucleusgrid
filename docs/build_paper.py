...
add_para(
    ...
    "are macroscopic. The KEWPIE2 [15] excitation-function calculation included "
    "in the supplementary material of this work targets this entrance channel; "
    "the predicted α-correlation chain visible in the prompt detector terminates "
    "after roughly 1 day at Mt-279, while the long-lived Bh and Db end-products "
    "would require chemical-isolation methods to observe. The persistence of the "
